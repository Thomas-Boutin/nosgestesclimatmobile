import {EngineParser, Question} from './engineParser';

describe('engineParser', () => {
  it('it should update the bilan result for logement to 4 when the user ansewer', () => {
  ...
  it('using the "logement . chauffage . baisse température . nombre degré" should return the correct question', () => {
    ...
    const questionResult = new EngineParser().getQuestion(
      'logement . chauffage . baisse température . nombre degré',
    );
